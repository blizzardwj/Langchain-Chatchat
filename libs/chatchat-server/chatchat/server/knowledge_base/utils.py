...
from chatchat.server.knowledge_base.kb_metadatas import BaseMetadata  # , KB_NEED_METADATA
...
def format_reference(kb_name: str, docs: List[Dict], api_base_url: str = "") -> List[Dict]:
    ...
    llm_contexts = "/n/n".join(contexts)
    return source_documents, llm_contexts
